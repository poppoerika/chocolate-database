...
function show_form() { 			
	...
	echo "<td> <a href=DeleteChocolate.php?id=" . $data->getId() . ">" . "Delete" . "</a></td>";
...
<?php
  ...
  function deleteIt($chocolateD) {
  	echo "About to Delete Chocolate ID " . $chocolateD ;
